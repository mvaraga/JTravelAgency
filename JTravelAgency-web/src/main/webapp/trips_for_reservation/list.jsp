    ...
    <s:layout-component name="body">
        ...
        <script>
            $(window).on('load', function() {
                ...
                //$(".customersUsername").attr("value", $.trim($("a#username").text()));
                if (lang == "sk") {
        ...
        <div style="vertical-align: middle;">
            <c:forEach items="${actionBean.trips}" var="trip" varStatus="loop">
                <table class="table table-bordered table-striped" style="width: 700px; margin: 20px auto;">
                    <tr>
                        ...
                        <td style="position: relative;">
                            ...
                            <div style="position: absolute; bottom: 0; right: 0; padding: 0 8px 8px 0;">
                                <s:form beanclass="cz.muni.fi.pa165.jtravelagency.web.TripsForReservationActionBean">
                                    <s:hidden name="tripId" value="${trip.id}"/>
                                    ...
                                    <button name="add" type="submit" class="btn btn-default"><span class="glyphicon glyphicon-shopping-cart"></span> <f:message key="tripsforreservation.reserve"/></button>
                                </s:form>
                            </div>
                        </td>
                    </tr>
